...
/**
 * Based on Californium's CoapObserverRealtions. Small changes were made.
 * @author Thomas Wiss
 */
public class CoapPubSubObserveRelation {

	/** The logger. */
	private static final Logger LOGGER = Logger.getLogger(CoapPubSubObserveRelation.class.getCanonicalName());
	 ...
	 */
	protected CoapPubSubObserveRelation(Request request, Endpoint endpoint) {
